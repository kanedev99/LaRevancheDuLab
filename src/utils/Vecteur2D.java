...
public class Vecteur2D {
	...
	public  double x;	//composante x du vecteur 2d
	public double y;	//composante y du vecteur 2d
	...
	/**
	 * Normalise ce vecteur, donc le vecteur devient un vecteur unitaire
	 * @return Le vecteur normalisé
	 */
	// Maysa Zahi
	...
	/**
	 * Calcule le vecteur opposé à ce vecteur
	 *
	 * @return Le vecteur opposé à ce vecteur
	 */
	//Maysa Zahi
	public Vecteur2D negation() {
		x = -this.x;
		y = -this.y;
	...
	/***
	 * Calcule et retourne le vecteur strictement positif
	 * @return le vecteur positif
	 */
	//Kepler Paul-Émile
	public Vecteur2D vecPositif() {
	    double nouvX=x;
	    double nouvY=y;
	    if(this.x<0) {
	        nouvX=-this.x;
	    ...
	    return new Vecteur2D(nouvX,nouvY);
	}
